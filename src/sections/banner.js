...
import UnstoppableOnboard from "components/UnstoppableOnboard";
      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading>AUTO RECOVER</Heading>
            <div style={{fontSize: '24px', marginRight: '0.5rem', fontWeight: 'bold'}}>
              <p>
              A new and secure way to recover stolen cars from all around the globe using the power of web3. Try it out!.
              </p>
            </div>
            <br />
            <UnstoppableOnboard />
          ...
          <Box as="figure" sx={styles.illustration}>
            <Image src={"/images/cars/landing5.webp"} loading="lazy" alt="sever-rack" width="100%"/>
          </Box>
        </Box>
      </Container>
    </Box>
