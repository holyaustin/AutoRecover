    ...
    <Fragment>
      ...
      >
        ...
        >
          ...
          <Image src="/images/logo/logonew.png" loading="lazy" sx={styles.logo} alt="logo" />
            ...
            <Flex sx={styles.buttonGroup}>
              ...
              <a href="https://id.worldcoin.org/use?action_id=0xa6D6f4556B022c0C7051d62E071c0ACecE5a1228&signal=0x0000000000000000000000000000000000000000&app_name=AutoRecover&return_to=https://autorecover.vercel.app/" target="_blank" rel="noreferrer" style={{textDecoration: "none"}}>
              <Button
                variant="text"
                sx={{
