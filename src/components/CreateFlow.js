...
export const CreateFlow = () => {
  ...
  function calculateFlowRate(amount) {
    ...
    if (typeof Number(amount) !== 'number' || isNaN(Number(amount)) === true) {
      ...
      const calculatedFlowRate = monthlyAmount * 3600 * 24 * 7;
  ...
  return (
    ...
    <div className="mt-2 text-red-500" align="center" style={{ padding: '15px 7px 5px 7px', fontSize: '26px' }}>
      ...
      <Form className='text-2xl'>
        ...
        <FormGroup className="mb-3 w-1/2">
          <FormControl
            ...
            placeholder="Copy flowRate above"
          />
        </FormGroup>
        <CreateButton
          size="lg"
          ...
          onClick={() => {
            ...
            alert('Bounty Streaming started successfully');
          }}
